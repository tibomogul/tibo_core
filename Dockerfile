...
ARG build_node_version=24.14.1
ENV NODE_VERSION=$build_node_version

ARG NVM_DIR=/home/${USER_NAME}/.nvm
ARG build_nvm_install_version=v0.40.4
...
COPY --chown=${USER_NAME}:${USER_NAME} tibo_core.gemspec  ./
COPY --chown=${USER_NAME}:${USER_NAME} lib/tibo_core/version.rb ./lib/tibo_core/
